...
namespace BetLab.EthicalWeb.Controllers
{
    public class MyBetsController : Controller
    {
        ...
        public MyBetsController(ApiService apiService, EthicalSessionManager sessionManager)
        {
        ...
        public async Task<IActionResult> Index(string tab = "all")
        {
            ...
            // Pre-fetch cash-out preview pentru fiecare bilet Open
            ...
            var model = new MyBetsPageViewModel
            {
                Bets = bets,
                ActiveTab = tab,
                CashOutPreviews = previews
            };
            return View(model);
        }
        ...
        public async Task<IActionResult> CashOut(int betSlipId)
        {
            ...
            {
                TempData["CashOutError"] = error ?? "Cash Out indisponibil.";
            }
